...
export SCOT_CONF=${workspace_home}/config/menc.conf

printf "${normalc}Configuration file path(HB): `echo $HARTEBEEST_CONF_PATH`\n"
printf "${normalc}Configuration file path(MENC): `echo $SCOT_CONF`\n"
...
numactl --membind 0 ./build/bin/scotmc-st-testbin 24 8
